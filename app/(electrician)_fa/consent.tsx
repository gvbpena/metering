            ...
            <ScrollView>
                <View className="flex-1 bg-white px-6 pt-10">
                    ...
                    <View className="mt-6 space-y-4 mb-8">
                        <Text className="font-semibold text-lg mb-2">Agreement</Text>
                        <View className="flex-row space-x-4">
                            <TouchableOpacity
                                className={`flex-1 px-4 py-3 shadow-md border border-gray-300 ${
                                    agreement === true ? "bg-green-500 border-green-500 text-white" : "bg-white text-gray-700"
                                }`}
                                onPress={() => setAgreement(true)}
                            >
                                <Text className={`text-center ${agreement === true ? "font-semibold text-white" : "text-gray-700"}`}>Agree and Consent</Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                                className={`flex-1 px-4 py-3 shadow-md border border-gray-300 ${
                                    agreement === false ? "bg-red-500 border-red-500 text-white" : "bg-white text-gray-700"
                                }`}
                                onPress={() => setAgreement(false)}
                            >
                                <Text className={`text-center ${agreement === false ? "font-semibold text-white" : "text-gray-700"}`}>Do Not Agree</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
