...
const SignaturePage = () => {
    ...
    const handleSignatureSave = async (signatureImage: string) => {
        ...
        setIsConfirmed(true);
        await AsyncStorage.setItem("userSignature", signatureImage);
    };
        ...
        <View className="flex-1 bg-gray-50 px-6">
            ...
            <View className="flex-row justify-between w-full mt-6">
                {!isConfirmed ? (
                    ...
                    <TouchableOpacity onPress={handleSaveSignature} className="bg-green-500 rounded-md py-3 flex-row justify-center items-center w-full mt-4">
